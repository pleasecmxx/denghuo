  ...
  <div class="tableStyle">
    <div class="searchBox">
      <div class="searchLeft">
        ...
        <el-select v-model="search.type" placeholder="活动类型" style="margin-left:10px;">
          <el-option
            v-for="item in type"
            :key="item.value"
            :label="item.label"
    ...
    >
      ...
      <el-table-column prop="title" label="模板标题" show-overflow-tooltip></el-table-column>
      <el-table-column prop="personNum" label="人数" show-overflow-tooltip></el-table-column>
      <el-table-column prop="startTime" label="活动开始时间" show-overflow-tooltip></el-table-column>
      <el-table-column prop="actvityTime" label="活动时长" show-overflow-tooltip></el-table-column>
      <el-table-column prop="status" label="重复状态" show-overflow-tooltip></el-table-column>
