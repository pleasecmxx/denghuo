...
<template>
  <div class="tableStyle">
    ...
    >
      ...
      <el-table-column prop="popNumber" label="弹窗编号" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column prop="publishObj" label="发布对象" show-overflow-tooltip></el-table-column>
      <el-table-column prop="publishArea" label="发布区域" show-overflow-tooltip></el-table-column>
      <el-table-column prop="showFrequency" label="单个用户展示频次" show-overflow-tooltip></el-table-column>
      <el-table-column prop="operating" label="操作" show-overflow-tooltip>
        <template slot-scope="scope">
          <span @click="revise(scope.$index, scope.row)" style="color:#0079fe;">
